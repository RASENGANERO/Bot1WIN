languages = {
    "ru": {
        ...
        "register_info": """<b>⚠️ Ошибка: Регистрация не пройдена!</b>

<b>✦ При регистрации обязательно вводите промокод - honor17</b>
...
● After completing your first deposit, you will automatically receive a <b>notification</b> from the bot.""",
        ...
        "register_info": """<b>⚠️ Error: Registration not completed!</b>

<b>✦ Please enter the promo code honor17 during registration.</b>
...
🟢 6. In case of an unsuccessful signal, we recommend doubling (x²) your bet to completely cover the loss with the next signal.""",
    ...
    "hi": {
        ...
        "register_info": """<b>⚠️ त्रुटि: पंजीकरण पूरा नहीं हुआ!</b>

<b>✦ कृपया पंजीकरण के दौरान प्रमोशनल कोड honor17 दर्ज करें।</b>
...
● अपने पहले जमा को पूरा करने के बाद, आपको स्वचालित रूप से बॉट से एक <b>सूचना</b> प्राप्त होगी।""",
    ...
    "es": {
        ...
        "register_info": """<b>⚠️ Error: ¡Registro no completado!</b>

<b>✦ Durante el registro, ingrese el código promocional honor17.</b>
...
● Después de completar tu primer depósito, recibirás automáticamente una <b>notificación</b> del bot.""",
    ...
    "az": {
        ...
        "register_info": """<b>⚠️ Xəta: Qeydiyyat tamamlanmadı!</b>

<b>✦ Qeydiyyat zamanı honor17 promosyon kodunu daxil edin.</b>
...
● İlk depozitinizi tamamladıqdan sonra, sizə avtomatik olaraq botdan <b>bilmə</b> gələcək.""",
    ...
    "pt": {
        ...
        "register_info": """<b>⚠️ Erro: Registro não concluído!</b>

<b>✦ Durante o registro, insira o código promocional honor17.</b>
...
● Após completar seu primeiro depósito, você receberá automaticamente uma <b>notificação</b> do bot.""",
    ...
    "tr": {
        ...
        "register_info": """<b>⚠️ Hata: Kayıt tamamlanmadı!</b>

<b>✦ Kayıt sırasında honor17 promosyon kodunu girin.</b>
...
● İlk yatırımınızı tamamladıktan sonra, bottan otomatik bir <b>bildirim</b> alacaksınız.""",
    ...
    "ar": {
        ...
        "welcome_message": """<b>Əsas menyu:</b>""",
        "register_info": """<b>⚠️ خطأ: لم تكتمل عملية التسجيل!</b>

<b>✦ أثناء التسجيل، يرجى إدخال الرمز الترويجي honor17.</b>
...
● بعد إكمال إيداعك الأول، ستتلقى تلقائيًا <b>إشعارًا</b> من الروبوت.""",
    ...
    "uz": {
        ...
        "register_info": """<b>⚠️ Xato: Ro'yxatdan o'tish tugamadi!</b>

<b>✦ Ro'yxatdan o'tish vaqtida honor17 promo-kodini kiriting.</b>
